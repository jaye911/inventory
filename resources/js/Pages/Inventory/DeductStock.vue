...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div v-if="inventoryItems.length === 0">
                <Card>
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 mb-4">No items with available stock to deduct</p>
            ...
            <template v-else>
                <!-- Info Banner -->
                <div class="mb-6 p-4 bg-orange-50 rounded-xl border border-orange-100 flex items-start gap-4">
                    ...
                    <div>
                        <p class="font-medium text-orange-900">Deduct Stock from Inventory</p>
                        <p class="text-sm text-orange-700">Select items and enter the quantity to deduct. Only items with available stock are shown.</p>
                    </div>
                </div>
                    ...
                    <form @submit.prevent="submit">
                                ...
                                >
                                    ...
                                    <div class="flex items-center justify-between mb-6">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <h3 class="font-semibold text-gray-900">Stock Deduction {{ index + 1 }}</h3>
                                        </div>
                                        <button
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <option
                                                    ...
                                                    :value="invItem.id"
                                                >
                                                    {{ invItem.name }} ({{ formatQuantity(invItem.quantity) }} {{ invItem.unit?.abbreviation }} available)
                                                </option>
                                            </select>
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input
                                                    ...
                                                    step="0.0001"
                                                    min="0.0001"
                                                    :max="getMaxQuantity(item.inventory_item_id)"
                                                    placeholder="0"
                                                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 pr-16"
                                                />
                                                <span
                                            ...
                                            >
                                                Available: {{ formatQuantity(getSelectedItem(item.inventory_item_id)?.quantity) }}
                                                {{ getSelectedItem(item.inventory_item_id)?.unit?.abbreviation }}
                                            </p>
                        ...
                        <div class="mt-6">
                            <button
                                ...
                                class="w-full p-4 border-2 border-dashed border-gray-300 rounded-xl text-gray-500 hover:border-orange-500 hover:text-orange-600 hover:bg-orange-50 transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
